...
Обеспечивает обратную совместимость и служит целью для сборки.

Для разработки исходный код находится в src/app.py
"""
...
# Импорт функции compute - сначала относительный, затем прямой
try:
...
def run_cli(n: int = 1000000) -> float:
    """Запуск вычисления в режиме командной строки."""
...
def run_gui():
    """Запуск вычисления в GUI режиме."""
    try:
    ...
    title_label = ttk.Label(
        main_frame, text="Калькулятор суммы квадратов",
        font=("Arial", 16, "bold")
    )
